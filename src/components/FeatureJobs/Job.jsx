...
const Job = ({ job }) => {
    ...
    return (
        <div className='singleJob border px-8 pt-2 rounded-md'>
            ...
            <p className='p-2 border my-3 border-indigo-700 w-24 text-center rounded'>{category}</p>
            ...
            <Link to={`/job/${id}`}>
                <button className='px-2 py-3 bg-gradient-to-r from-blue-500 to-purple-500 rounded-md text-white my-2'>View Details</button></Link>
